...
\begin{figure}
  ...
  \caption{Dominant vortical structures at $\ured = \urte$ observed in the pure cruciform case. The slice shown here is the $x/D = 1.96D$ ($1D$ downstream the trailing edge of strip plate) plane, viewed orthogonal to that plane from downstream.} \label{fig:vortStruct90}
\end{figure}
...
\begin{figure}
  ...
  \caption{Evolution of the normalised \rms{} amplitude of cylinder displacement $\yrsm$, with respect to reduced velocity $\ured$, for the \angfo{} and \angth{} cruciform.}
  \label{fig:yStrRMS23}
\end{figure}
