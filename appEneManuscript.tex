...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.38\textwidth}
    ...
    \label{fig:yStrRMS2}
  \end{subfigure}
  \caption{The amplitude response as the evolution of normalised RMS amplitude of cylinder displacement in the streamwise vortex-driven vibration regime.} \label{fig:yStrRMSStreamwise}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.35\textwidth}
    ...
    \label{fig:yStrFreq4}
  \end{subfigure}
  \caption{The normalised cylinder displacement frequency in the streamwise vortex-driven vibration regime.} \label{fig:yStrFreqStreamwise}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.38\textwidth}
    ...
    \label{fig:clRMS2}
  \end{subfigure}
  \caption{The evolution of the RMS amplitude of lift coefficient,  with respect to reduced velocity $\ured$ in the streamwise vortex-driven regime.} \label{fig:clRMSStreamwise}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.38\textwidth}
    ...
    \label{fig:clFreq4}
  \end{subfigure}
  \caption{The evolution of the normalised frequency of lift coefficient, $\fclstr$ with respect to reduced velocity $\ured$ in the streamwise vortex-driven regime.} \label{fig:yStrRMSStreamwise}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.38\textwidth}
    ...
    \label{fig:yStrRMS3}
  \end{subfigure}
  \caption{The amplitude response as the evolution of normalised RMS amplitude of cylinder displacement in the region where Karman and streamwise vortex-driven vibrations are most suppressed.} \label{fig:yStrRMSSuppressed}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.38\textwidth}
    ...
    \label{fig:yStrFreq3}
  \end{subfigure}
  \caption{The normalised cylinder displacement frequency in the vibration regime where both Karman and streamwise vortex-driven vibrations are most suppressed.} \label{fig:yStrFreqSuppressed}
\end{figure}
...
\begin{figure}
  ...
  \caption{The evolution of the RMS amplitude of lift coefficient,  with respect to reduced velocity $\ured$ in the streamwise vortex-driven regime.} \label{fig:clRMSSuppressed}
\end{figure}
...
\begin{figure}
  ...
  \caption{The evolution of the normalised frequency of lift coefficient, $\fclstr$ with respect to reduced velocity $\ured$ in the region where Karman and streamwise vortex-induced vibrations are most suppressed.} \label{fig:clFreqSuppressed}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.35\textwidth}
    ...
    \label{fig:yStrRMS5}
  \end{subfigure}
  \caption{The amplitude response as the evolution of normalised RMS amplitude of cylinder displacement in the enhanced Karman vortex-driven regime.} \label{fig:yStrFreqKarman}
\end{figure}
...
\begin{figure}
  ...
  \begin{subfigure}[h]{0.35\textwidth}
    ...
    \label{fig:yStrFreq1}
  \end{subfigure}
  \caption{The normalised cylinder displacement frequency in the enhanced Karman vortex-driven regime.} \label{fig:yStrFreqKarman}
\end{figure}
...
\begin{figure}
  ...
  \caption{The evolution of the RMS amplitude of lift coefficient,  with respect to reduced velocity $\ured$ in the Karman vortex-driven regime.} \label{fig:clRMSKarman}
\end{figure}
...
\begin{figure}
  ...
  \caption{The evolution of the normalised frequency of the lift coefficient,  with respect to reduced velocity $\ured$ in the Karman vortex-driven regime.} \label{fig:clFreqKarman}
\end{figure}
...
\begin{figure}
  ...
  \caption{Isocontours describing the map of the normalised RMS amplitude of cylinder displacment, $\yrms$ in the strip plate tilt angle - reduced velocity ($\alpha$-$\ured$) parameter space.}
  \label{fig:yRMSContour}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.38\textwidth]{figs/powerRMSContour}
  \caption{Isocontours describing the map of the estimated mechanical power in the strip plate tilt angle - reduced velocity ($\alpha$-$\ured$) parameter space.}
  \label{fig:powerRMSContou}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.39\textwidth]{figs/efficiencyRMSContour}
  \caption{Isocontours describing the map of the estimated mechanical power in the strip plate tilt angle - reduced velocity ($\alpha$-$\ured$) parameter space.}
  \label{fig:efficiencyRMSContour}
\end{figure}
